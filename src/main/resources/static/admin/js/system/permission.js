$(document).ready(function() {
    ...
    $("#__btn_search").click(function() {
        ...
        doPost("/admin/system/permission/list", data, function(response) {
            createList(response);
        });
    });
    ...
    $("#__btnConnectMenu").click(function() {
        location.href = "/admin/system/permission_menu";
    });
    ...
    $("#__btnDelete").click(function() {
        ...
        if(confirm("선택한 항목을 삭제하시겠습니까?")) {
            ...
            doPost("/admin/system/permission/delete", seqs
                , function(response) {
    ...
    $("#__modal_btn_save").click(function(event) {
        ...
        if(isNew){
            if(confirm("새로운 권한을 등록하시겠습니까?")) {
                doPost("/admin/system/permission/append", data
                    , function(response) {
                        let code = response.code;
                        if(code === 200) {
                            alert("권한이 등록되었습니다.");
            ...
            if(confirm("권한 정보를 수정하시겠습니까?")) {
                doPost("/admin/system/permission/modify", data
                    , function(response) {
                        let code = response.code;
                        if(code === 200) {
