...
$(document).ready(function() {
    ...
    $("#__modal_btn_save").click(function() {
        ...
        if(confirm(confirmMsg)) {
            let url = isNew ? "/admin/system/menu/append" : "/admin/system/menu/modify";
...
function loadMenuTree() {
    doPost("/admin/system/menu/list", {}, function(response) {
    ...
    $(".btn-delete").click(function(e) {
        ...
        if(menuData) {
            ...
            if(confirm("'" + menuData.name + "' 메뉴를 삭제하시겠습니까?")) {
                doPost("/admin/system/menu/delete", [seq], function(response) {
                    if(response.code === 200) {
                        alert("메뉴가 삭제되었습니다.");
                        loadMenuTree();
                    } else {
